...
with col4:
        st.text('Prácticas Chile es un programa gestionado por el Servicio Civil, \nque busca promover y atraer talento joven al Estado, y que permite a \nestudiantes de carreras universitarias y técnicas realizar sus prácticas en ministerios \ny servicios públicos, poniendo al servicio del país sus conocimientos y habilidades.')
