...
with st.container():
    ...
    if seleccion=="Por región":
        ...
        st.write("Selecciona la región a comparar")
        region=st.selectbox("Región",["Arica y Parinacota","Tarapacá","Antofagasta","Atacama","Coquimbo","Valparaíso","Metropolitana","O’Higgins","Maule","Ñuble","Biobío","Araucanía","Los Ríos","Los Lagos","Aysén","Magallanes"])
