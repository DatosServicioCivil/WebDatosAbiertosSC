...
if a=='Normas de Gestión de Personas':
    ...
    with st.container():
        ...
        with col1:
            ...
            valor_col_1_1=f"{Norma_1[Norma_1['Año']==2018].Metrica:.2%}".replace(",", ".")
            valor_col_1_2=f"{Norma_1[Norma_1['Año']==2019].Metrica:.2%}".replace(",", ".")
            valor_col_1_3=f"{Norma_1[Norma_1['Año']==2020].Metrica:.2%}".replace(",", ".")
            valor_col_1_4=f"{Norma_1[Norma_1['Año']==2021].Metrica:.2%}".replace(",", ".")
            valor_col_1_5=f"{Norma_1[Norma_1['Año']==2022].Metrica:.2%}".replace(",", ".")
            with col_1_1:
        ...
        with col2:
            ...
            valor_col_2_1=f"{Norma_2[Norma_2['Año']==2018].Metrica:.2%}".replace(",", ".")
            valor_col_2_2=f"{Norma_2[Norma_2['Año']==2019].Metrica:.2%}".replace(",", ".")
            valor_col_2_3=f"{Norma_2[Norma_2['Año']==2020].Metrica:.2%}".replace(",", ".")
            valor_col_2_4=f"{Norma_2[Norma_2['Año']==2021].Metrica:.2%}".replace(",", ".")
            valor_col_2_5=f"{Norma_2[Norma_2['Año']==2022].Metrica:.2%}".replace(",", ".")
            with col_2_1:
        ...
        with col4:
            ...
            valor_col_4_1=f"{Norma_4[Norma_4['Año']==2018].Metrica:.2%}".replace(",", ".")
            valor_col_4_2=f"{Norma_4[Norma_4['Año']==2019].Metrica:.2%}".replace(",", ".")
            valor_col_4_3=f"{Norma_4[Norma_4['Año']==2020].Metrica:.2%}".replace(",", ".")
            valor_col_4_4=f"{Norma_4[Norma_4['Año']==2021].Metrica:.2%}".replace(",", ".")
            valor_col_4_5=f"{Norma_4[Norma_4['Año']==2022].Metrica:.2%}".replace(",", ".")
            with col_4_1:
