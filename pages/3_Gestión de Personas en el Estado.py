...
if a=='Normas de Gestión de Personas':
    ...
    with st.container():
        ...
        with col1:
            ...
            valor_col_1_1 = "{:,}".format(Norma_1.query('Año==2018').Metrica.iloc[0])
            valor_col_1_1 = "{:,}".format(Norma_1.query('Año==2019').Metrica.iloc[0])
            valor_col_1_1 = "{:,}".format(Norma_1.query('Año==2020').Metrica.iloc[0])
            valor_col_1_1 = "{:,}".format(Norma_1.query('Año==2021').Metrica.iloc[0])
            valor_col_1_1 = "{:,}".format(Norma_1.query('Año==2022').Metrica.iloc[0])
            with col_1_1:
