...
if a=='Normas de Gestión de Personas':
    ...
    with st.container():
        ...
        with col1:
            ...
            valor_col_1_1=Norma_1[Norma_1['Año']==2018].Metrica
            valor_col_1_2=Norma_1[Norma_1['Año']==2019].Metrica
            valor_col_1_3=Norma_1[Norma_1['Año']==2020].Metrica
            valor_col_1_4=Norma_1[Norma_1['Año']==2021].Metrica
            valor_col_1_5=Norma_1[Norma_1['Año']==2022].Metrica
            with col_1_1:
