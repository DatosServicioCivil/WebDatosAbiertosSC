...
with st.sidebar:
    a=st.radio('Gestión de Personas: ',['Normas de Gestión de Personas','Capacitación en el Estado','Integridad','Egresos ADP'])
...
if a=='Normas de Gestión de Personas':
    ...
    with st.container():
        col1,col2,col3=st.columns(3,gap='small')
        with col1:
            titulo_Norma_1="""Estándares Áreas de Gestión y Desarrollo de Personas"""
            ...
            with col_1_1:
                st.markdown(f"<h5 style='text-align: center; color: grey;'>{valor_col_1_1}</h5>", unsafe_allow_html=True)
                st.markdown("<h5 style='text-align: center; color: grey;'>2018</h5>", unsafe_allow_html=True)
            with col_1_2:
                st.markdown(f"<h5 style='text-align: center; color: grey;'>{valor_col_1_2}</h5>", unsafe_allow_html=True)
                st.markdown("<h5 style='text-align: center; color: grey;'>2019</h5>", unsafe_allow_html=True)
            with col_1_3:
                st.markdown(f"<h5 style='text-align: center; color: grey;'>{valor_col_1_3}</h5>", unsafe_allow_html=True)
                st.markdown("<h5 style='text-align: center; color: grey;'>2020</h5>", unsafe_allow_html=True)
            with col_1_4:
                st.markdown(f"<h5 style='text-align: center; color: grey;'>{valor_col_1_4}</h5>", unsafe_allow_html=True)
        ...
        with col2:
            ...
            with col_2_1:
                ...
                st.markdown("<h5 style='text-align: center; color: grey;'>2018</h5>", unsafe_allow_html=True)
            with col_2_2:
                st.markdown(f"<h5 style='text-align: center; color: grey;'>{valor_col_2_2}</h5>", unsafe_allow_html=True)
                st.markdown("<h5 style='text-align: center; color: grey;'>2019</h5>", unsafe_allow_html=True)
            with col_2_3:
                st.markdown(f"<h5 style='text-align: center; color: grey;'>{valor_col_2_3}</h5>", unsafe_allow_html=True)
                st.markdown("<h5 style='text-align: center; color: grey;'>2020</h5>", unsafe_allow_html=True)
            with col_2_4:
                st.markdown(f"<h5 style='text-align: center; color: grey;'>{valor_col_2_4}</h5>", unsafe_allow_html=True)
                st.markdown("<h5 style='text-align: center; color: grey;'>2021</h5>", unsafe_allow_html=True)
            with col_2_5:
        ...
        with col3:
            ...
            with col_3_1:
                st.markdown(f"<h5 style='text-align: center; color: grey;'>{valor_col_3_1}</h5>", unsafe_allow_html=True)
                st.markdown("<h5 style='text-align: center; color: grey;'>2018</h5>", unsafe_allow_html=True)
            with col_3_2:
                st.markdown(f"<h5 style='text-align: center; color: grey;'>{valor_col_3_2}</h5>", unsafe_allow_html=True)
                st.markdown("<h5 style='text-align: center; color: grey;'>2019</h5>", unsafe_allow_html=True)
            with col_3_3:
                st.markdown(f"<h5 style='text-align: center; color: grey;'>{valor_col_3_3}</h5>", unsafe_allow_html=True)
                st.markdown("<h5 style='text-align: center; color: grey;'>2020</h5>", unsafe_allow_html=True)
            with col_3_4:
                st.markdown(f"<h5 style='text-align: center; color: grey;'>{valor_col_3_4}</h5>", unsafe_allow_html=True)
                st.markdown("<h5 style='text-align: center; color: grey;'>2021</h5>", unsafe_allow_html=True)
            with col_3_5:
    ...
    with st.container():
        ...
        with col4:
            ...
            with col_4_1:
                st.markdown(f"<h5 style='text-align: center; color: black;'>{valor_col_4_1}</h5>", unsafe_allow_html=True)
                st.markdown("<h5 style='text-align: center; color: black;'>2018</h5>", unsafe_allow_html=True)
            with col_4_2:
                st.markdown(f"<h5 style='text-align: center; color: black;'>{valor_col_4_2}</h5>", unsafe_allow_html=True)
                st.markdown("<h5 style='text-align: center; color: black;'>2019</h5>", unsafe_allow_html=True)
            with col_4_3:
                st.markdown(f"<h5 style='text-align: center; color: black;'>{valor_col_4_3}</h5>", unsafe_allow_html=True)
                st.markdown("<h5 style='text-align: center; color: black;'>2020</h5>", unsafe_allow_html=True)
            with col_4_4:
                st.markdown(f"<h5 style='text-align: center; color: black;'>{valor_col_4_4}</h5>", unsafe_allow_html=True)
                st.markdown("<h5 style='text-align: center; color: black;'>2021</h5>", unsafe_allow_html=True)
            with col_4_5:
                st.markdown(f"<h5 style='text-align: center; color: black;'>{valor_col_4_5}</h5>", unsafe_allow_html=True)
                st.markdown("<h5 style='text-align: center; color: black;'>2022</h5>", unsafe_allow_html=True)
            st.markdown(f"<h6 style='text-align: center; color: black;'>{texto_Norma_4}</h6>", unsafe_allow_html=True)
        ...
        with col5:
            ...
            with col_5_1:
                st.markdown(f"<h5 style='text-align: center; color: black;'>{valor_col_5_1}</h5>", unsafe_allow_html=True)
                st.markdown("<h5 style='text-align: center; color: black;'>2018</h5>", unsafe_allow_html=True)
            with col_5_2:
                st.markdown(f"<h5 style='text-align: center; color: black;'>{valor_col_5_2}</h5>", unsafe_allow_html=True)
                st.markdown("<h5 style='text-align: center; color: black;'>2019</h5>", unsafe_allow_html=True)
            with col_5_3:
                st.markdown(f"<h5 style='text-align: center; color: black;'>{valor_col_5_3}</h5>", unsafe_allow_html=True)
                st.markdown("<h5 style='text-align: center; color: black;'>2020</h5>", unsafe_allow_html=True)
            with col_5_4:
                st.markdown(f"<h5 style='text-align: center; color: black;'>{valor_col_5_4}</h5>", unsafe_allow_html=True)
                st.markdown("<h5 style='text-align: center; color: black;'>2021</h5>", unsafe_allow_html=True)
            with col_5_5:
                st.markdown(f"<h5 style='text-align: center; color: black;'>{valor_col_5_5}</h5>", unsafe_allow_html=True)
                st.markdown("<h5 style='text-align: center; color: black;'>2022</h5>", unsafe_allow_html=True)
            st.markdown(f"<h6 style='text-align: center; color: black;'>{texto_Norma_5}</h6>", unsafe_allow_html=True)
        ...
        with col6:
            ...
            with col_6_1:
                st.markdown(f"<h5 style='text-align: center; color: black;'>{valor_col_6_1}</h5>", unsafe_allow_html=True)
                st.markdown("<h5 style='text-align: center; color: black;'>2018</h5>", unsafe_allow_html=True)
            with col_6_2:
                st.markdown(f"<h5 style='text-align: center; color: black;'>{valor_col_6_2}</h5>", unsafe_allow_html=True)
                st.markdown("<h5 style='text-align: center; color: black;'>2019</h5>", unsafe_allow_html=True)
            with col_6_3:
                st.markdown(f"<h5 style='text-align: center; color: black;'>{valor_col_6_3}</h5>", unsafe_allow_html=True)
                st.markdown("<h5 style='text-align: center; color: black;'>2020</h5>", unsafe_allow_html=True)
            with col_6_4:
                st.markdown(f"<h5 style='text-align: center; color: black;'>{valor_col_6_4}</h5>", unsafe_allow_html=True)
                st.markdown("<h5 style='text-align: center; color: black;'>2021</h5>", unsafe_allow_html=True)
            with col_6_5:
                st.markdown(f"<h5 style='text-align: center; color: black;'>{valor_col_6_5}</h5>", unsafe_allow_html=True)
                st.markdown("<h5 style='text-align: center; color: black;'>2022</h5>", unsafe_allow_html=True)
            st.markdown(f"<h6 style='text-align: center; color: black;'>{texto_Norma_6}</h6>", unsafe_allow_html=True)
        
        with st.container():
            col7,col8,col9=st.columns(3,gap='small')
            with col7:
                titulo_Norma_7="""Ambientes Laborales y Calidad de Vida"""
                st.markdown(f"<h4 style='text-align: center; color: grey;'>{titulo_Norma_7}</h4>", unsafe_allow_html=True)
                col_4_1,col_4_2,col_4_3,col_4_4,col_4_5=st.columns(5,gap='small')
                texto_Norma_4="""Total de Vacantes de planta que se concursaron para los diferentes tipos de concursos"""
                valor_col_4_1=f"{Norma_4.query('Año==2018').Metrica.iloc[0]:,}"
                valor_col_4_2=f"{Norma_4.query('Año==2019').Metrica.iloc[0]:,}"
                ...
                with col_4_5:
                    ...
                    st.markdown("<h5 style='text-align: center; color: grey;'>2022</h5>", unsafe_allow_html=True)
                st.markdown(f"<h6 style='text-align: center; color: grey;'>{texto_Norma_4}</h6>", unsafe_allow_html=True)

            with col8:
                titulo_Norma_8="""Participación Funcionaria"""
                st.markdown(f"<h4 style='text-align: center; color: grey;'>{titulo_Norma_8}</h4>", unsafe_allow_html=True)
                col_8_1,col_8_2,col_8_3,col_8_4,col_8_5=st.columns(5,gap='small')
                texto_Norma_8="""Porcentaje de Servicios Públicos que declaran haber realizado Inducción en un plazo menor a 30 días"""
                valor_col_8_1=f"{Norma_8.query('Año==2018').Metrica.iloc[0]:.2%}"
                valor_col_8_2=f"{Norma_8.query('Año==2019').Metrica.iloc[0]:.2%}"
                valor_col_8_3=f"{Norma_8.query('Año==2020').Metrica.iloc[0]:.2%}"
                valor_col_8_4=f"{Norma_8.query('Año==2021').Metrica.iloc[0]:.2%}"
                valor_col_8_5=f"{Norma_8.query('Año==2022').Metrica.iloc[0]:.2%}"
                with col_8_1:
                    st.markdown(f"<h5 style='text-align: center; color: grey;'>{valor_col_8_1}</h5>", unsafe_allow_html=True)
                    st.markdown("<h5 style='text-align: center; color: grey;'>2018</h5>", unsafe_allow_html=True)
                with col_8_2:
                    st.markdown(f"<h5 style='text-align: center; color: grey;'>{valor_col_8_2}</h5>", unsafe_allow_html=True)
                    st.markdown("<h5 style='text-align: center; color: grey;'>2019</h5>", unsafe_allow_html=True)
                with col_8_3:
                    st.markdown(f"<h5 style='text-align: center; color: grey;'>{valor_col_8_3}</h5>", unsafe_allow_html=True)
                    st.markdown("<h5 style='text-align: center; color: grey;'>2020</h5>", unsafe_allow_html=True)
                with col_8_4:
                    st.markdown(f"<h5 style='text-align: center; color: grey;'>{valor_col_8_4}</h5>", unsafe_allow_html=True)
                    st.markdown("<h5 style='text-align: center; color: grey;'>2021</h5>", unsafe_allow_html=True)
                with col_8_5:
                    st.markdown(f"<h5 style='text-align: center; color: grey;'>{valor_col_8_5}</h5>", unsafe_allow_html=True)
                    st.markdown("<h5 style='text-align: center; color: grey;'>2022</h5>", unsafe_allow_html=True)
                st.markdown(f"<h6 style='text-align: center; color: grey;'>{texto_Norma_8}</h6>", unsafe_allow_html=True)

            with col9:
                titulo_Norma_9="""Formación y Capacitación"""
                st.markdown(f"<h4 style='text-align: center; color: grey;'>{titulo_Norma_9}</h4>", unsafe_allow_html=True)
                col_9_1,col_9_2,col_9_3,col_9_4,col_9_5=st.columns(5,gap='small')
                texto_Norma_9="""Total de Participantes en actividades de capacitación informado en plataforma SISPUBLI"""
                valor_col_9_1=f"{Norma_9.query('Año==2018').Metrica.iloc[0]:,}"
                valor_col_9_2=f"{Norma_9.query('Año==2019').Metrica.iloc[0]:,}"
                valor_col_9_3=f"{Norma_9.query('Año==2020').Metrica.iloc[0]:,}"
                valor_col_9_4=f"{Norma_9.query('Año==2021').Metrica.iloc[0]:,}"
                valor_col_9_5=f"{Norma_9.query('Año==2022').Metrica.iloc[0]:,}"
                with col_9_1:
                    st.markdown(f"<h5 style='text-align: center; color: grey;'>{valor_col_9_1}</h5>", unsafe_allow_html=True)
                    st.markdown("<h5 style='text-align: center; color: grey;'>2018</h5>", unsafe_allow_html=True)
                with col_9_2:
                    st.markdown(f"<h5 style='text-align: center; color: grey;'>{valor_col_9_2}</h5>", unsafe_allow_html=True)
                    st.markdown("<h5 style='text-align: center; color: grey;'>2019</h5>", unsafe_allow_html=True)
                with col_9_3:
                    st.markdown(f"<h5 style='text-align: center; color: grey;'>{valor_col_9_3}</h5>", unsafe_allow_html=True)
                    st.markdown("<h5 style='text-align: center; color: grey;'>2020</h5>", unsafe_allow_html=True)
                with col_9_4:
                    st.markdown(f"<h5 style='text-align: center; color: grey;'>{valor_col_9_4}</h5>", unsafe_allow_html=True)
                    st.markdown("<h5 style='text-align: center; color: grey;'>2021</h5>", unsafe_allow_html=True)
                with col_9_5:
                    st.markdown(f"<h5 style='text-align: center; color: grey;'>{valor_col_9_5}</h5>", unsafe_allow_html=True)
                    st.markdown("<h5 style='text-align: center; color: grey;'>2022</h5>", unsafe_allow_html=True)
                st.markdown(f"<h6 style='text-align: center; color: grey;'>{texto_Norma_9}</h6>", unsafe_allow_html=True)
        ...
        with st.container():
            ...
            with col10:
                ...
                with col_10_1:
                    ...
                    st.markdown("<h5 style='text-align: center; color: black;'>2018</h5>", unsafe_allow_html=True)
                with col_10_2:
                    st.markdown(f"<h5 style='text-align: center; color: black;'>{valor_col_10_2}</h5>", unsafe_allow_html=True)
                    st.markdown("<h5 style='text-align: center; color: black;'>2019</h5>", unsafe_allow_html=True)
                with col_10_3:
                    st.markdown(f"<h5 style='text-align: center; color: black;'>{valor_col_10_3}</h5>", unsafe_allow_html=True)
                    st.markdown("<h5 style='text-align: center; color: black;'>2020</h5>", unsafe_allow_html=True)
                with col_10_4:
                    st.markdown(f"<h5 style='text-align: center; color: black;'>{valor_col_10_4}</h5>", unsafe_allow_html=True)
                    st.markdown("<h5 style='text-align: center; color: black;'>2021</h5>", unsafe_allow_html=True)
                with col_10_5:
                    st.markdown(f"<h5 style='text-align: center; color: black;'>{valor_col_10_5}</h5>", unsafe_allow_html=True)
                    st.markdown("<h5 style='text-align: center; color: black;'>2022</h5>", unsafe_allow_html=True)
                st.markdown(f"<h6 style='text-align: center; color: black;'>{texto_Norma_10}</h6>", unsafe_allow_html=True)
            ...
            with col11:
                ...
                valor_col_11_2=f"{Norma_11.query('Año==2019').Metrica.iloc[0]:.2%}"
                valor_col_11_3=f"{Norma_11.query('Año==2020').Metrica.iloc[0]:.2%}"
                valor_col_11_4=f"{Norma_11.query('Año==2021').Metrica.iloc[0]:.2%}"
                valor_col_11_5=f"{Norma_11.query('Año==2022').Metrica.iloc[0]:.2%}"
                with col_11_1:
                    st.markdown(f"<h5 style='text-align: center; color: black;'>{valor_col_11_1}</h5>", unsafe_allow_html=True)
                    st.markdown("<h5 style='text-align: center; color: black;'>2018</h5>", unsafe_allow_html=True)
                with col_11_2:
                    st.markdown(f"<h5 style='text-align: center; color: black;'>{valor_col_11_2}</h5>", unsafe_allow_html=True)
                    st.markdown("<h5 style='text-align: center; color: black;'>2019</h5>", unsafe_allow_html=True)
                with col_11_3:
                    st.markdown(f"<h5 style='text-align: center; color: black;'>{valor_col_11_3}</h5>", unsafe_allow_html=True)
                    st.markdown("<h5 style='text-align: center; color: black;'>2020</h5>", unsafe_allow_html=True)
                with col_11_4:
                    st.markdown(f"<h5 style='text-align: center; color: black;'>{valor_col_11_4}</h5>", unsafe_allow_html=True)
                    st.markdown("<h5 style='text-align: center; color: black;'>2021</h5>", unsafe_allow_html=True)
                with col_11_5:
                    st.markdown(f"<h5 style='text-align: center; color: black;'>{valor_col_11_5}</h5>", unsafe_allow_html=True)
                    st.markdown("<h5 style='text-align: center; color: black;'>2022</h5>", unsafe_allow_html=True)
